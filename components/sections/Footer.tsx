      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li><a href="#" className="text-[var(--color-brand-white)]/70 hover:text-[var(--color-red)] transition-colors text-sm">Comfortable Sedans & SUVs</a></li>
              <li><a href="#" className="text-[var(--color-brand-white)]/70 hover:text-[var(--color-red)] transition-colors text-sm">Rugged Motorcycles</a></li>
              <li><a href="#" className="text-[var(--color-brand-white)]/70 hover:text-[var(--color-red)] transition-colors text-sm">City Scooties</a></li>
              <li><a href="#" className="text-[var(--color-brand-white)]/70 hover:text-[var(--color-red)] transition-colors text-sm">Off-Road 4x4s</a></li>
              <li><a href="#" className="text-[var(--color-brand-white)]/70 hover:text-[var(--color-red)] transition-colors text-sm">Tariffs & Pricing</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li><a href="/contact" className="text-[var(--color-brand-white)]/70 hover:text-[var(--color-red)] transition-colors text-sm">Contact</a></li>
        ...
        <div className="pt-8 border-t border-[var(--color-brand-white)]/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-[var(--color-brand-white)]/40 hover:text-[var(--color-red)] text-xs transition-colors">Privacy Policy</a>
            <a href="#" className="text-[var(--color-brand-white)]/40 hover:text-[var(--color-red)] text-xs transition-colors">Terms of Service</a>
            <a href="#" className="text-[var(--color-brand-white)]/40 hover:text-[var(--color-red)] text-xs transition-colors">Refund Policy</a>
          </div>
        </div>
