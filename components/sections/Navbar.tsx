    ...
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled || mobileMenuOpen
          ? "bg-black md:bg-[var(--color-forest)]/90 backdrop-blur-md shadow-lg py-4"
          : "bg-black md:bg-transparent py-4 md:py-6"
      }`}
    >
      ...
      {mobileMenuOpen && (
        <>
          ...
          <motion.div
            ...
            className="md:hidden bg-black border-t border-white/10 relative z-50"
            id="mobile-nav"
          >
